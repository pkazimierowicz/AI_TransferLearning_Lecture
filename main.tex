...
\section{But first, let's talk a bit about theory...}
 ...
 \section{Once again - will this really work?}
  	\begin{frame}{Examples}
		For our examples, we've taken Google's MobileNet (https://arxiv.org/abs/1704.04861) model, using reference TensorFlow implementation. We've also downloaded weights trained on the COCO dataset (http://cocodataset.org/#home).
	\end{frame}
	\begin{frame}{Examples - COCO}
		\includegraphics{images/coco-examples}
	\end{frame}
