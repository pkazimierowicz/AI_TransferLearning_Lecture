...
\begin{document}
	...
	\section{When do we need transfer learning?}
	%%%%%%%%%%%%%%%%
	\begin{frame}{When do we need transfer learning?}
	Lorem ipsum
	\end{frame}
	%%%%%%%%%%%%%%%%
	\section{How we can speed up the learning process with transfer learning?}
	%%%%%%%%%%%%%%%%
	\begin{frame}{How we can speed up the learning process with transfer learning?}
	Lorem ipsum
	\end{frame}

	\part{How does Transfer Learning work?}
